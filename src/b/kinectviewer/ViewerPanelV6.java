...
/* Based on OpenNI's SimpleViewer example
    ...
    Changes (July 2012):
       * updated the AlternativeViewpointCapability code in configOpenNI;
       * added depthGen.getMetaData() call to starty of getDepthImage() 
         to avoid a flickering viewpoint
*/
...
public class ViewerPanelV6 extends JPanel implements Runnable
{
